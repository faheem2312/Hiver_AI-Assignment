...
| 34 | 2026-09-13 | Real Kaggle Twitter Support Streamer (`fetch_real_amazon_data.py`) | Streams 12,000 genuine `@AmazonHelp` customer support tweets directly from the Hugging Face TWCS repository mirror, completely replacing any synthetic seeds with authentic customer dialogues. |
| 35 | 2026-09-14 | Real Data English Stopword Filter & Stratified Golden Split | Enforces ASCII density and common English stopword intersection to eliminate multilingual noise (German/Japanese/Italian), producing 2,792 clean real threads with 200 held-out golden benchmarks and 2,592 grounding pairs. |
